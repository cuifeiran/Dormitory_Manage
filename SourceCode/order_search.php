...
<!--_menu 作为公共模版分离出去-->
		...
		<section class="Hui-article-box">
			...
			<div class="Hui-article">
				<article class="cl pd-20">
					...
					<div class="text-c">
						<?php @$key=$_POST['order_no_name'];?>
						<input type="text" class="input-text" style="width:250px" placeholder="<?php echo($key);?>" id="" name="order_no_name">
					...
					<div class="cl pd-5 bg-1 bk-gray mt-20"> 
						<span class="l">
								...
								<a href="javascript:;" 
									onclick="member_add('入住登记','order_add.php','','450')" 
									class="btn btn-primary radius">
									<i class="Hui-iconfont">&#xe600;</i> 入住登记
								</a>
						</span> 
				...
				<table class="table table-border table-bordered table-hover table-bg table-sort">
					...
					@$sql="select * from orders where order_dor_no='$order_no_name'or order_stu_name='$order_no_name'";
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
					...
					<?php 
						include("db_conn.php");
						@$order_no_name=$_POST["order_no_name"];
						@$sql1="select * from orders where order_dor_no like '%{$_POST['order_no_name']}%'or order_stu_name like '%{$_POST['order_no_name']}%'";
