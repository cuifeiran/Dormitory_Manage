...
<article class="cl pd-20">
	...
	<form action="dor_add.php" method="post" class="form form-horizontal" >
		<input type="hidden" name="dor_del" value="0"/>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>宿舍号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="dor_no" name="dor_no">
			</div>
		</div>
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="" name="dor_head" id="dor_head">
			</div>
		</div>
			<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>手机：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="dor_tel" name="dor_tel">
			</div>
		</div>
