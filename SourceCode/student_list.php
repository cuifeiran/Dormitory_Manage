...
<!--_menu 作为公共模版分离出去-->
	<?php include("public/left_menu.php") ?>
		...
		<section class="Hui-article-box">
			<!--面包屑开始-->
			<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 学生系统 <span class="c-gray en">&gt;</span> 学生管理
			...
			<div class="Hui-article">
				<article class="cl pd-20">
					...
					<div class="text-c">
						<input type="text" class="input-text" style="width:250px" placeholder="输入学号或姓名" id="" name="stu_no_name">
					...
					<div class="cl pd-5 bg-1 bk-gray mt-20"> 
						<span class="l">
								...
								<a href="javascript:;" 
									onclick="member_add('学生登记','student_add.php','','450')" 
									class="btn btn-primary radius">
									<i class="Hui-iconfont">&#xe600;</i> 学生登记
								</a>
						</span> 
