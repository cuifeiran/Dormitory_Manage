...
<!--/meta 作为公共模版分离出去-->
		...
		<title>住宿管理 - 宿舍管理 - H-ui.admin v3.0</title>
...
<!--_menu 作为公共模版分离出去-->
	<?php include("public/left_menu.php") ?>
		...
		<section class="Hui-article-box">
			<!--面包屑开始-->
			<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 住宿管理 <span class="c-gray en">&gt;</span> 在住列表
			...
			<div class="Hui-article">
				<article class="cl pd-20">
					...
					<div class="text-c">
						<input type="text" class="input-text" style="width:250px" placeholder="输入学号或姓名" id="" name="order_no_name">
					...
					<div class="cl pd-5 bg-1 bk-gray mt-20"> 
						<span class="l">
								...
								<a href="javascript:;" 
									onclick="member_add('住宿登记','order_add.php','','450')" 
									class="btn btn-primary radius">
									<i class="Hui-iconfont">&#xe600;</i> 住宿登记
								</a>
						</span> 
				...
				<table class="table table-border table-bordered table-hover table-bg table-sort">
					...
					<tbody>
						<tr  class="text-c">
							...
							<td class="td-status"><span class="label label-success radius"><?php echo ($row["order_time"]);?></span></td>
