...
<article class="cl pd-20">
	...
	<form action="dor_recycle_del.php" method="post" class="form form-horizontal" >
		<!--宿舍ID-->
	<input type="hidden" name="dor_id" value="<?php echo $row['dor_id'];?>"/>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" disabled="disabled" class="input-text" value="<?php echo ($row['dor_per']);?>" placeholder="<?php echo ($row['dor_per']);?>" id="dor_tel" name="dor_tel">
			</div>
		</div>
